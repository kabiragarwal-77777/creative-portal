...
function publishPortalContext(extra) {
    ...
    const context = {
        app: 'meta',
        view,
        title: views[view] ? views[view].title : 'Meta Portal',
        subtitle: views[view] ? views[view].subtitle : 'Meta portal view',
        dateRange: {
        ...
        diagnostics: {
            source: currentDiagnostics.source || 'Meta + Metabase',
...
const views = {
    ...
    simulator: { title: 'ROAS Simulator', subtitle: 'Actual vs frozen checkpoint forecasts for immature ad cohorts' },
    recommendations: { title: 'Recommendations', subtitle: 'AI-generated creative recommendations based on learned patterns' },
    optimizer: { title: 'Campaign Optimizer', subtitle: 'AI-generated optimization plan with one-click execution' },
...
function renderCurrentView() {
    ...
    else if (view === 'optimizer') { if (typeof renderOptimizer === 'function') renderOptimizer(); }
    publishPortalContext();
}
