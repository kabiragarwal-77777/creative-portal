...
module.exports = function(config) {
    ...
    function getTrendlineData(adId) {
        ...
        const checkpointLines = checkpointRuns.map(run => ({
            ...
            points: HORIZONS.map(horizon => getRunPoint(run, horizon)),
        }));
        ...
        return {
            ...
            horizons,
            actualLine: horizons.map(horizon => ({
                horizon: horizon.label,
                day: horizon.day,
                value: horizon.actual_roas,
                revenue: horizon.actual_revenue,
                mature: horizon.mature,
            })),
